...
public class ListTester {
	...
	private void test_newList() {
		...
		try {
			...
			printTest("newList_testSet0A", testSet(newList(), 0, ELEMENT_A, Result.NoException));
	...
	private void test_emptyList_addToFrontA_A() {
		...
		try {
			...
			printTest("emptyList_addToFrontA_A_testListIteratorAdd59",testListIteratorAdd(listIteratorTest59(emptyList_addToFrontA_A()), ELEMENT_B,  Result.NoException));
	...
	private void test_A_addToFrontB_BA() {
		try {
			...
			printTest("A_addToFrontB_BA_testListIteratorHasNext",testListIteratorNext(listIteratorAfterNext(A_addToFrontB_BA(), 2), null, Result.NoSuchElement));
			
			printTest("A_addToFrontB_BA_testListIteratorHasNext",testListIterator(A_addToFrontB_BA(), Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorHasNext2",testListIteratorHasNext(listIteratorTest2(A_addToFrontB_BA()), Result.ConcurrentModification));
			
			printTest("A_addToFrontB_BA_testListIteratorHasNext3",testListIteratorHasNext(listIteratorTest3(A_addToFrontB_BA()), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext4",testListIteratorHasNext(listIteratorTest4(A_addToFrontB_BA(), ELEMENT_A, ELEMENT_B), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext5",testListIteratorHasNext(listIteratorTest5(A_addToFrontB_BA(), ELEMENT_A), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext6",testListIteratorHasNext(listIteratorTest6(A_addToFrontB_BA(), ELEMENT_A), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext7",testListIteratorHasNext(listIteratorTest7(A_addToFrontB_BA(), 0, ELEMENT_A), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext8",testListIteratorHasNext(listIteratorTest8(A_addToFrontB_BA(), 0, ELEMENT_A), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext9",testListIteratorHasNext(listIteratorTest9(A_addToFrontB_BA(),  ELEMENT_A), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext10",testListIteratorHasNext(listIteratorTest10(A_addToFrontB_BA(),  0), Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorNext11",testListIteratorNext(listIteratorTest11(A_addToFrontB_BA()), ELEMENT_A, Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorHasNext12",testListIteratorHasNext(listIteratorTest12(A_addToFrontB_BA()), Result.False));
			printTest("A_addToFrontB_BA_testListIteratorNext13",testListIteratorNext(listIteratorTest13(A_addToFrontB_BA()), ELEMENT_A, Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorNext14",testListIteratorNext(listIteratorTest14(A_addToFrontB_BA()), ELEMENT_A, Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorNext15",testListIteratorNext(listIteratorTest15(A_addToFrontB_BA()), ELEMENT_A, Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorRemove16",testListIteratorRemove(A_addToFrontB_BA().listIterator(), Result.IllegalState));
			printTest("A_addToFrontB_BA_testListIteratorRemove17",testListIteratorRemove(listIteratorTest17(A_addToFrontB_BA()), Result.IllegalState));
			printTest("A_addToFrontB_BA_testListIteratorPrevious18",testListIteratorPrevious(listIteratorTest18(A_addToFrontB_BA()), null,  Result.NoSuchElement));
			printTest("A_addToFrontB_BA_testListIteratorHasNext19",testListIteratorHasNext(listIteratorTest19(A_addToFrontB_BA()),  Result.True));
			printTest("A_addToFrontB_BA_testListIteratorNext20",testListIteratorNext(listIteratorTest20(A_addToFrontB_BA()), ELEMENT_B,  Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorPrevious21",testListIteratorPrevious(listIteratorTest21(A_addToFrontB_BA()), ELEMENT_B,  Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorNext22",testListIteratorNext(listIteratorTest22(A_addToFrontB_BA()), ELEMENT_A,  Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorIndex23",testListIteratorPrevious(listIteratorTest23(A_addToFrontB_BA()), ELEMENT_A,  Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorIndex24",testListIteratorIndex(A_addToFrontB_BA(), 3,  Result.IndexOutOfBounds));
			printTest("A_addToFrontB_BA_testListIteratorIndex25",testListIteratorIndex(A_addToFrontB_BA(), -1,  Result.IndexOutOfBounds));
			printTest("A_addToFrontB_BA_testListIteratorSet26",testListIteratorSet(A_addToFrontB_BA().listIterator(), ELEMENT_C,  Result.IllegalState));
			printTest("A_addToFrontB_BA_testListIteratorSet27",testListIteratorSet(listIteratorTest27(A_addToFrontB_BA()), ELEMENT_C,  Result.IllegalState));
			printTest("A_addToFrontB_BA_testListIteratorSet28",testListIteratorSet(listIteratorTest28(A_addToFrontB_BA()), ELEMENT_C,  Result.IllegalState));
			printTest("A_addToFrontB_BA_testListIteratorSet29",testListIteratorSet(listIteratorTest29(A_addToFrontB_BA()), ELEMENT_C,  Result.IllegalState));
			printTest("A_addToFrontB_BA_testListIteratorSet30",testListIteratorSet(listIteratorTest30(A_addToFrontB_BA()), ELEMENT_C,  Result.IllegalState));
			printTest("A_addToFrontB_BA_testListIteratorSet31",testListIteratorSet(listIteratorTest31(A_addToFrontB_BA()), ELEMENT_C,  Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorSet32",testListIteratorSet(listIteratorTest32(A_addToFrontB_BA()), ELEMENT_C,  Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorSet33",testListIteratorSet(listIteratorTest33(A_addToFrontB_BA()), ELEMENT_C,  Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorSet34",testListIteratorSet(listIteratorTest34(A_addToFrontB_BA()), ELEMENT_C,  Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorNext35",testListIteratorNext(listIteratorTest35(A_addToFrontB_BA()), ELEMENT_A,  Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorPrevious36",testListIteratorPrevious(listIteratorTest36(A_addToFrontB_BA()), ELEMENT_B,  Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorPrevious37",testListIteratorPrevious(listIteratorTest37(A_addToFrontB_BA()), ELEMENT_C,  Result.MatchingValue));
			printTest("A_addToFrontB_BA_testListIteratorPrevious38",testListIteratorAdd(listIteratorTest38(A_addToFrontB_BA()), ELEMENT_C,  Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorPrevious39",testListIteratorAdd(listIteratorTest39(A_addToFrontB_BA()), ELEMENT_C,  Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorPrevious40",testListIteratorAdd(listIteratorTest40(A_addToFrontB_BA()), ELEMENT_C,  Result.NoException));
			printTest("A_addToFrontB_BA_testListIteratorNext41",testListIteratorNext(listIteratorTest4149(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorPrevious42",testListIteratorPrevious(listIteratorTest4149(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorAdd43",testListIteratorAdd(listIteratorTest4149(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorSet44",testListIteratorSet(listIteratorTest4149(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorRemove45",testListIteratorRemove(listIteratorTest4149(A_addToFrontB_BA()),  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext46",testListIteratorHasNext(listIteratorTest4149(A_addToFrontB_BA()),  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasPrevious47",testListIteratorHasPrevious(listIteratorTest4149(A_addToFrontB_BA()),  Result.ConcurrentModification));
			
			printTest("A_addToFrontB_BA_testListIteratorNext50",testListIteratorNext(listIteratorTest5058(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorPrevious51",testListIteratorPrevious(listIteratorTest5058(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorAdd52",testListIteratorAdd(listIteratorTest5058(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorSet53",testListIteratorSet(listIteratorTest5058(A_addToFrontB_BA()), null,  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorRemove54",testListIteratorRemove(listIteratorTest5058(A_addToFrontB_BA()),  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasNext55",testListIteratorHasNext(listIteratorTest5058(A_addToFrontB_BA()),  Result.ConcurrentModification));
			printTest("A_addToFrontB_BA_testListIteratorHasPrevious56",testListIteratorHasPrevious(listIteratorTest5058(A_addToFrontB_BA()),  Result.ConcurrentModification));
	...
	private void test_A_removeFirst_emptyList() {
		try {
			...
			printTest("A_removeFirst_emptyList_testSet0A", testSet(A_removeFirst_emptyList(), 0, ELEMENT_A, Result.NoException));
	...
	private void test_A_removeLast_emptyList() {
		try {
			...
			printTest("A_removeLast_emptyList_testSet0A", testSet(A_removeLast_emptyList(), 0, ELEMENT_A, Result.NoException));
	...
	private void test_A_removeA_emptyList() {
		...
		try {
			...
			printTest("A_removeA_emptyList_testSet0A", testSet(A_removeA_emptyList(), 0, ELEMENT_A, Result.NoException));
	...
	private void test_A_remove0_emptyList() {
		...
		try {
			...
			printTest("A_remove0_emptyList_testSet0A", testSet(A_remove0_emptyList(), 0, ELEMENT_A, Result.NoException));
	...
	//XXX LIST ITERATOR HELPER METHODS

	/**
	 * Helper for testing ListIterators. Return a ListIterator that has been advanced numCallsToNext times.
	 * @param list
	 * @param numCallsToNext
	 * @return ListIterator for given list, after numCallsToNext
	 */
	@SuppressWarnings("unchecked")
	private ListIterator<Integer> listIteratorAfterNext(DoubleLinkedListADT<Integer> list, int numCallsToNext) {
		@SuppressWarnings("rawtypes")
	 ...
	 * @param ListIterator
	 * @return same ListIterator following a call to remove()
	 */
	@SuppressWarnings("unused")
	private ListIterator<Integer> listIteratorAfterRemove(ListIterator<Integer> iterator) {
		iterator.remove();
		return iterator;
	}
	...
	/**
	 * Runs the ListIterator constructor to check for an exceptions
	 * @param list a list already prepared for a given change scenario
	 * @param expectedResult
	 * @return success 
	 */
	private boolean testListIterator(DoubleLinkedListADT<Integer> list, Result expectedResult) {
		Result result;
		try {
			@SuppressWarnings("unused")
	...
	/**
	 * Runs the ListIterator constructor at a certain index to check for an exceptions
	 * @param list a list already prepared for a given change scenario
	 * @param index of the starting point of the ListIterator
	 * @param expectedResult
	 * @return success 
	 */
	private boolean testListIteratorIndex(DoubleLinkedListADT<Integer> list, int index, Result expectedResult) {
		Result result;
		try {
			@SuppressWarnings("unused")
			ListIterator<Integer> lit = list.listIterator(index);
			result = Result.NoException;
		} 
		catch(IndexOutOfBoundsException e)
		{
	 ...
	 * @return success 
	 */
	private boolean testListIteratorHasNext(ListIterator<Integer> listIterator, Result expectedResult) {
		Result result;
		try {
	...
	/**
	 * Runs list's listIterator next() method on a given list and checks result against expectedResult
	 * @param iterator an iterator already positioned for the call to hasNext()
	 * @param expectedValue the Integer expected from next() or null if an exception is expected
	 * @param expectedResult MatchingValue or expected exception
	 * @return test success
	...
	/**
	 * Runs list's listIterator previous() method on a given list and checks result against expectedResult
	 * @param iterator an iterator already positioned for the call to hasPrevious()
	 * @param expectedValue the Integer expected from prev() or null if an exception is expected
	 * @param expectedResult MatchingValue or expected exception
	 * @return test success
	 */
	private boolean testListIteratorPrevious(ListIterator<Integer> iterator, Integer expectedValue, Result expectedResult) {
		Result result;
		try {
	 ...
	 * @return test success
	 */
	private boolean testListIteratorHasPrevious(ListIterator<Integer> listIterator, Result expectedResult) {
		Result result;
		try {
	...
	/**
	 * Runs list's listIterator remove() method on a given list and checks result against expectedResult
	 * @param ListIterator a ListIterator that may or may not already be able to remove()
	 * @param expectedResult MatchingValue or expected exception
	 * @return test success
	 */
	private boolean testListIteratorRemove(ListIterator<Integer> iterator, Result expectedResult) {
		Result result;
		try {
			iterator.remove();
			result = Result.NoException;
			...
			System.out.printf("%s caught unexpected %s\n", "testListIteratorRemove", e.toString());
			e.printStackTrace();
			result = Result.UnexpectedException;
		}
		return result == expectedResult;
	...
	/**
	 * Runs list's listIterator add() method on a given list and checks result against expectedResult
	 * @param ListIterator a ListIterator that calls add() at the current location
	 * @param element that is expected to be added
	 * @param expectedResult MatchingValue or expected exception
	 * @return test success
	 */
	private boolean testListIteratorAdd(ListIterator<Integer> listIterator, Integer element, Result expectedResult) {
		Result result;
		try {
			...
			System.out.printf("%s caught unexpected %s\n", "testListIteratorAdd", e.toString());
			e.printStackTrace();
			result = Result.UnexpectedException;
		}
	...
	/**
	 * Runs list's listIterator set() method on a given list and checks result against expectedResult
	 * @param ListIterator a ListIterator that calls set() at the current location
	 * @param element that is expected to be set
	 * @param expectedResult MatchingValue or expected exception
	 * @return test success
	 */
	private boolean testListIteratorSet(ListIterator<Integer> listIterator, Integer element, Result expectedResult) {
		Result result;
		try {
	...
	//XXX CUSTOM TEST HELPER METHODS
	
	/**
	 * Helper method for specified test scenario #2
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest2(DoubleLinkedListADT<Integer> list) //2
	{
		ListIterator<Integer> lit = list.listIterator();
		list.removeFirst();
		return lit;
	...
	/**
	 * Helper method for specified test scenario #3
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest3(DoubleLinkedListADT<Integer> list) //3
	{
		ListIterator<Integer> lit = list.listIterator();
		list.removeLast();
		return lit;
	...
	/**
	 * Helper method for specified test scenario #4
	 * @param list
	 * @param target that element is being added after
	 * @param element that is being added after the target
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest4(DoubleLinkedListADT<Integer> list, Integer target, Integer element ) //4
	{
		ListIterator<Integer> lit = list.listIterator();
		list.addAfter(target, element);
		return lit;
	}
	
	/**
	 * Helper method for specified test scenario #5
	 * @param list
	 * @param element that is being added to the rear of the list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest5(DoubleLinkedListADT<Integer> list, Integer element ) //5
	{
		ListIterator<Integer> lit = list.listIterator();
		list.addToRear(element); 
		return lit;
	...
	/**
	 * Helper method for specified test scenario #6
	 * @param list
	 * @param element that is being removed from the list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest6(DoubleLinkedListADT<Integer> list, Integer element ) //6
	{
		ListIterator<Integer> lit = list.listIterator();
		list.remove(element); 
		return lit;
	...
	/**
	 * Helper method for specified test scenario #7
	 * @param list
	 * @param index that the element is being added at
	 * @param element that is being added to the specific index in the list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest7(DoubleLinkedListADT<Integer> list, int index, Integer element ) //7
	{
		ListIterator<Integer> lit = list.listIterator();
		list.add(index, element); 
		return lit;
	...
	/**
	 * Helper method for specified test scenario #8
	 * @param list
	 * @param index that the element is being set at
	 * @param element that is being set to the specific index in the list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest8(DoubleLinkedListADT<Integer> list, int index, Integer element ) //8
	{
		ListIterator<Integer> lit = list.listIterator();
		list.set(index, element); 
		return lit;
	 ...
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest9(DoubleLinkedListADT<Integer> list, Integer element ) //9
	{
		ListIterator<Integer> lit = list.listIterator();
		list.add(element); 
		return lit;
	...
	/**
	 * Helper method for specified test scenario #10
	 * @param list
	 * @param index that the Iterator is removing from
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest10(DoubleLinkedListADT<Integer> list, int index) //10
	{
		ListIterator<Integer> lit = list.listIterator();
		list.remove(index);
		return lit;
	...
	/**
	 * Helper method for specified test scenario #11
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest11(DoubleLinkedListADT<Integer> list) //11
	{
	...
	/**
	 * Helper method for specified test scenario #12
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest12(DoubleLinkedListADT<Integer> list) //12
	{
	...
	/**
	 * Helper method for specified test scenario #13 (intentionally throwing 
	 * ConcurrentModificationException)
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest13(DoubleLinkedListADT<Integer> list) //13
	{
	...
	/**
	 * Helper method for specified test scenario #14 (intentionally throwing 
	 * ConcurrentModificationException)
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest14(DoubleLinkedListADT<Integer> list) //14
	{
	...
	/**
	 * Helper method for specified test scenario #15 (intentionally throwing 
	 * ConcurrentModificationException)
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest15(DoubleLinkedListADT<Integer> list) //15
	{
	...
	/**
	 * Helper method for specified test scenario #17
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest17(DoubleLinkedListADT<Integer> list) //17
	{
	...
	/**
	 * Helper method for specified test scenario #18
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest18(DoubleLinkedListADT<Integer> list) //18
	{
	...
	/**
	 * Helper method for specified test scenario #19
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest19(DoubleLinkedListADT<Integer> list) //19
	{
	...
	/**
	 * Helper method for specified test scenario #20
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest20(DoubleLinkedListADT<Integer> list) //20
	{
	...
	/**
	 * Helper method for specified test scenario #21
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest21(DoubleLinkedListADT<Integer> list) //21
	{
	...
	/**
	 * Helper method for specified test scenario #22
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest22(DoubleLinkedListADT<Integer> list) //22
	{
	...
	/**
	 * Helper method for specified test scenario #23
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest23(DoubleLinkedListADT<Integer> list) //23
	{
	...
	/**
	 * Helper method for specified test scenario #26
	 * @param list
	 * @return lit
	 */
	@SuppressWarnings("unused")
	private ListIterator<Integer> listIteratorTest26(DoubleLinkedListADT<Integer> list) //26
	{
	
	ListIterator<Integer> lit = list.listIterator(4);
	...
	/**
	 * Helper method for specified test scenario #27
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest27(DoubleLinkedListADT<Integer> list) //27
	{
	...
	/**
	 * Helper method for specified test scenario #28
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest28(DoubleLinkedListADT<Integer> list) //28
	{
	...
	/**
	 * Helper method for specified test scenario #29
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest29(DoubleLinkedListADT<Integer> list) //29
	{
	...
	/**
	 * Helper method for specified test scenario #30
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest30(DoubleLinkedListADT<Integer> list) //30
	{
	...
	/**
	 * Helper method for specified test scenario #31
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest31(DoubleLinkedListADT<Integer> list) //31
	{
	...
	/**
	 * Helper method for specified test scenario #32
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest32(DoubleLinkedListADT<Integer> list) //32
	{
	...
	/**
	 * Helper method for specified test scenario #33
	 * @param list
	 * @return lit
	 */
	private ListIterator<Integer> listIteratorTest33(DoubleLinkedListADT<Integer> list) //33
	{
	...
	private ListIterator<Integer> listIteratorTest34(DoubleLinkedListADT<Integer> list) //34
	{
	...
	private ListIterator<Integer> listIteratorTest35(DoubleLinkedListADT<Integer> list) //35
	{
	...
	private ListIterator<Integer> listIteratorTest36(DoubleLinkedListADT<Integer> list) //36
	{
	...
	private ListIterator<Integer> listIteratorTest37(DoubleLinkedListADT<Integer> list) //37
	{
	...
	private ListIterator<Integer> listIteratorTest38(DoubleLinkedListADT<Integer> list) //38
	{
	...
	private ListIterator<Integer> listIteratorTest39(DoubleLinkedListADT<Integer> list) //39
	{
	...
	private ListIterator<Integer> listIteratorTest40(DoubleLinkedListADT<Integer> list) //40
	{
	...
	private ListIterator<Integer> listIteratorTest4149(DoubleLinkedListADT<Integer> list) //41 - 49
	{
	...
	private ListIterator<Integer> listIteratorTest5058(DoubleLinkedListADT<Integer> list) //50 - 58
	{
	...
	//XXX MVail ListTester Test helper Methods
	
	private ListIterator<Integer> listIteratorTest59(DoubleLinkedListADT<Integer> list) //59
	{
